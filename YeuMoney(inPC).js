...
`;
        ...
        transferBtn.style.boxShadow = '0 4px 8px rgba(0, 0, 0, 1)';
        ...
        transferBtn.style.transition = 'transform 0.2s ease-in-out, box-shadow 0.2s ease-in-out';
        transferBtn.addEventListener('mouseenter', () => {
            transferBtn.style.transform = 'translateY(3px)';
            transferBtn.style.boxShadow = '0 3px 6px rgba(0, 0, 0, 1)';
        });
        transferBtn.addEventListener('mouseleave', () => {
            transferBtn.style.transform = 'translateY(0)';
            transferBtn.style.boxShadow = '0 6px 12px rgba(0, 0, 0, 1)';
        });
        transferBtn.addEventListener('mousedown', () => {
            transferBtn.style.transform = 'translateY(6px)';
            transferBtn.style.boxShadow = '0 1px 2px rgba(0, 0, 0, 2)';
        });
        transferBtn.addEventListener('mouseup', () => {
            transferBtn.style.transform = 'translateY(3px)';
            transferBtn.style.boxShadow = '0 3px 6px rgba(0, 0, 0, 1)';
        });
        ...
        transferBtn.onclick = () => {
            ...
            if (codeInputField && confirmButton) {
                ...
                input.value = 'Lỗi: Không Tìm Thấy Nhiệm Vụ';
        ...
        reloadBtn.style.boxShadow = '0 6px 12px rgba(0, 0, 0, 0.6)';
        ...
        reloadBtn.addEventListener('mouseenter', () => {
            ...
            reloadBtn.style.boxShadow = '0 3px 6px rgba(0, 0, 0, 0.6)';
        });
        ...
        reloadBtn.addEventListener('mousedown', () => {
            ...
            reloadBtn.style.boxShadow = '0 1px 2px rgba(0, 0, 0, 0.8)';
        });
        ...
        errorLink.style.margin = '10px auto 5px';
