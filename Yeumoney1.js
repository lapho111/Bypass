...
title.style.textSconsthadow = '0 0 5px rgba(255, 255, 255, 0.7), 0 0 10px rgba(255, 255, 255, 0.6), 0 0 15px rgba(255, 255, 255, 0.5)'; // Hiệu ứng hào quang nhẹ
container.appendChild(title);
  ...
  input.style.color = 'white'; // Đổi màu chữ thành trắng cho dễ nhìn
        input.style.marginBottom = '10px';
        input.style.padding = '8px';
  input.style.paddingLeft = '15px';  // Tạo khoảng cách từ bên trái
...
buttonRow.style.flexDirection = 'column'; // xếp theo chiều dọc
buttonRow.style.gap = '10px'; // khoảng cách giữa hai nút
